...
export const AnalyticsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-center gap-[100px] py-20">
      <div className="flex flex-col w-full max-w-[512px] items-center gap-5">
      ...
      <div className="flex flex-col items-start gap-[50px] w-full max-w-[1000px]">
        <div className="flex items-center justify-between gap-[50px] w-full">
          {statistics.map((stat, index) => (
            <div
              key={index}
              className="flex flex-col w-[300px] items-center gap-3"
            >
              <div className="self-stretch mt-[-1.00px] [font-family:'Montserrat',Helvetica] font-bold text-white text-[28px] text-center tracking-[0] leading-9">
                {stat.value}
              </div>
