...
import { EasySetupSection } from "@/components/sections/EasySetupSection";
...
export const LandingPage = () => {
    ...
    return (
      ...
      /> */}
            ...
            <header
                className={`flex w-full max-w-[1000px] items-center justify-between fixed top-4 md:top-8 left-1/2 -translate-x-1/2 bg-transparent z-50 px-4 md:px-6 transition-all duration-400 ease-in-out ${isHeaderVisible
            ...
            >
                ...
                <div className="inline-flex items-center gap-2.5 relative">
                    <Button
                        variant="ghost"
                        size="sm"
                        className={`h-auto px-0 py-0 font-bold text-sm tracking-[0] leading-[normal] hover:bg-transparent ${selectedLanguage === "EN" ? "text-[#33fff9]" : "text-[#f2f2f2]"
                            }`}
                    ...
                    <Button
                        variant="ghost"
                        size="sm"
                        className={`h-auto px-0 py-0 font-bold text-sm tracking-[0] leading-[normal] hover:bg-transparent ${selectedLanguage === "VI" ? "text-[#33fff9]" : "text-[#f2f2f2]"
                            }`}
